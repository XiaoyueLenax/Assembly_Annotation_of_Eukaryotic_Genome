...
#Change permission of assembly otherwise there is an error (I did not fully understand why) and go to folder where results should be stored.
chmod ugo+rwx ${assembly}
cd ${assembly_merqury_dir}

#Run merqury to assess the quality of the assemblies; do not indent
apptainer exec \
--bind $course_dir \
